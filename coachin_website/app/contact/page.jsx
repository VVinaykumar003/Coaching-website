    ...
    <main className="pt-12 lg:pt-8 pb-12 min-h-[60vh] font-sans">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div>
            <div className="card bg-white shadow-layered-card border border-[#E2E8F0] rounded-[16px] p-6 h-full">
              <h3 className="text-2xl font-bold mb-4">Contact Information</h3>
              <div className="space-y-4">
                {/* Address */}
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-primary/10 text-primary rounded-xl flex items-center justify-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg></div>
                  <div>
          ...
          {/* Right Side: Form */}
          <div>
            <div className="card bg-white shadow-layered-card border border-[#E2E8F0] rounded-[16px] p-6">
              <form className="space-y-4">
                ...
                <div className="form-control">
                  ...
                  <textarea className="textarea textarea-bordered h-24 bg-[#F8FAFC] focus:bg-white transition-colors w-full" placeholder="Tell us how we can help..."></textarea>
                </div>
        ...
        <div className="mt-8 flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 max-w-4xl mx-auto mb-8">
          ...
          <div className="w-full max-w-md aspect-video bg-base-300 rounded-[16px] shadow-layered-card overflow-hidden border border-[#E2E8F0]">
            <iframe
        ...
        <div className="mt-8">
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            {faqs.map((faq, index) => (
              <div key={index} className="collapse collapse-plus bg-white border border-[#E2E8F0] shadow-layered-card rounded-[16px] transition-all hover:shadow-md">
